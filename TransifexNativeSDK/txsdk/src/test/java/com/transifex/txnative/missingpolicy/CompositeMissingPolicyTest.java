...
public class CompositeMissingPolicyTest {
    ...
    public void testGet_normal() {
        ...
        when(missingPolicy1.get(anyString())).thenAnswer(new Answer<String>() {
            @Override
        ...
        when(missingPolicy2.get(anyString())).thenAnswer(new Answer<String>() {
            @Override
            public String answer(InvocationOnMock invocation) throws Throwable {
                Object[] args = invocation.getArguments();
        ...
        String result = compositeMissingPolicy.get("test").toString();
        ...
        inOrder.verify(missingPolicy1).get("test");
        inOrder.verify(missingPolicy2).get("test end");
